  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-2">
      <div className="flex items-start gap-3">
        <div className="w-11 h-11 rounded-full bg-[#E24B4A] flex items-center justify-center text-white font-bold text-sm shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[#E24B4A] text-xs">{doctor.specialty}</p>
